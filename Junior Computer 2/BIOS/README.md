...
However, you can use the already pre build BIOS images. "BIOS - 8K.BIN" is for a 27C64 EPROM or 28C64 EEPROM, while "BIOS - 32K.BIN" should be used for 27C256 or 28C256 ROMs.
